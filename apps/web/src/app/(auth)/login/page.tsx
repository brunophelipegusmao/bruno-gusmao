    ...
    <main className="flex items-center justify-center min-h-[80vh] px-4">
      <div className="relative w-full max-w-sm bg-secondary rounded-2xl overflow-hidden p-8 flex flex-col gap-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center bg-foreground text-secondary font-heading uppercase text-sm px-4 py-3 rounded-xl hover:bg-foreground/80 transition-colors"
          >
            Entrar
          </button>
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-2 border border-border bg-background text-foreground font-heading uppercase text-sm px-4 py-3 rounded-xl hover:bg-secondary transition-colors"
          >
